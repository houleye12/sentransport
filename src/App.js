...
function App() {
  const lignes = [
    ...
    { id: 8,  numero: "5",  depart: "HLM",       arrivee: "Medina",    arrets: 7,  couleur: "#d35400" },
    { id: 9,  numero: "9",  depart: "Dieuppeul", arrivee: "Sandaga",   arrets: 13, couleur: "#27ae60" },
    { id: 10, numero: "18", depart: "Sicap",     arrivee: "Colobane",  arrets: 8,  couleur: "#2c3e50" },
  ];
